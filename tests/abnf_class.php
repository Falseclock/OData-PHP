...
{
	public $odataUri                           = "(?: <serviceRoot> (?: <odataRelativeUri> )?  )";
	public $serviceRoot                        = "(?: https | http\:\/\/<host> (?: (?: \:<port> ) )? \/ (?: (?: <segment_nz>\/ ) )*  )";
	public $odataRelativeUri                   = "(?: \$batch (?: (?: \?<batchOptions> ) )?  ) | (?: \$entity\?<entityOptions> ) | (?: \$entity\/<optionallyQualifiedEntityTypeName>\?<entityCastOptions> ) | (?: \$metadata (?: (?: \?<metadataOptions> ) )?  (?: <context> )?  ) | (?: <resourcePath> (?: (?: \?<queryOptions> ) )?  )";
	...
	public $collectionNavigation               = "(?:  (?: (?: \/<optionallyQualifiedEntityTypeName> ) )?  (?: <collectionNavPath> )?  )";
	...
	public $singleNavigation                   = "(?:  (?: (?: \/<optionallyQualifiedEntityTypeName> ) )?  (?: (?: \/<propertyPath> ) | <boundOperation> | <ref> | <value> | <querySegment> )?  )";
	...
	public $complexColPath                     = "<ordinalIndex> | (?:  (?: (?: \/<optionallyQualifiedComplexTypeName> ) )?  (?: <count> | <boundOperation> | <querySegment> )?  )";
	public $complexPath                        = "(?:  (?: (?: \/<optionallyQualifiedComplexTypeName> ) )?  (?: (?: \/<propertyPath> ) | <boundOperation> | <querySegment> )?  )";
	...
	public $expandItem                         = "\$value | <expandPath> | (?: <optionallyQualifiedEntityTypeName>\/<expandPath> )";
	public $expandPath                         = "(?:  (?: (?: <complexProperty> | <complexColProperty> | <optionallyQualifiedComplexTypeName> | <complexAnnotationInQuery>\/ ) )* (?: <STAR> (?: <ref> | (?: <OPEN><levels><CLOSE> ) )?  ) | <streamProperty> | (?: <navigationProperty> | <entityAnnotationInQuery> (?: (?: \/<optionallyQualifiedEntityTypeName> ) )?  (?: (?: <ref> (?: (?: <OPEN><expandRefOption> (?: (?: <SEMI><expandRefOption> ) )* <CLOSE> ) )?  ) | (?: <count> (?: (?: <OPEN><expandCountOption> (?: (?: <SEMI><expandCountOption> ) )* <CLOSE> ) )?  ) | (?: <OPEN><expandOption> (?: (?: <SEMI><expandOption> ) )* <CLOSE> ) )?  ) )";
	...
	public $selectItem                         = "<STAR> | <allOperationsInSchema> | <selectProperty> | <optionallyQualifiedActionName> | <optionallyQualifiedFunctionName> | (?: <optionallyQualifiedEntityTypeName> | <optionallyQualifiedComplexTypeName>\/<selectProperty> | <optionallyQualifiedActionName> | <optionallyQualifiedFunctionName> )";
	...
	public $selectPath                         = "(?: <complexProperty> | <complexColProperty> | <complexAnnotationInQuery> (?: (?: \/<optionallyQualifiedComplexTypeName> ) )?  )";
	...
	public $memberExpr                         = "<directMemberExpr> | (?: <optionallyQualifiedEntityTypeName> | <optionallyQualifiedComplexTypeName>\/<directMemberExpr> )";
	...
	public $collectionNavigationExpr           = "(?:  (?: (?: \/<optionallyQualifiedEntityTypeName> ) )? <collectionPathExpr> | (?: <keyPredicate> (?: <singleNavigationExpr> )?  ) | (?: <filterExpr> (?: <collectionNavigationExpr> )?  ) )";
	public $singleNavigationExpr               = "(?: \/<memberExpr> )";
	public $filterExpr                         = "(?: \/\$filter<OPEN><boolCommonExpr><CLOSE> )";
	public $complexColPathExpr                 = "<collectionPathExpr> | (?: \/<optionallyQualifiedComplexTypeName> (?: <collectionPathExpr> )?  )";
	...
	public $complexPathExpr                    = "(?: \/<directMemberExpr> ) | (?: \/<optionallyQualifiedComplexTypeName> (?: (?: \/<directMemberExpr> ) )?  )";
	...
	public $optionallyQualifiedEntityTypeName  = "(?:  (?: (?: <namespace>\. ) )? <entityTypeName> )";
	public $optionallyQualifiedComplexTypeName = "(?:  (?: (?: <namespace>\. ) )? <complexTypeName> )";
